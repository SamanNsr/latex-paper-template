...
\begin{document}
	...
	\maketitle
	% Print your title, author name and date; comment if you want a cover page
	...
	\input{content/3-litreview}
	\input{content/4-theory}
	\input{content/5-researchdesign}
	\input{content/6-analysis}
	\input{content/7-conclusion}
	\input{content/8-bibliography}
	\input{content/9A-appendix}
